...
index[0] = values['APPLE'][i] * values['APPLE - NUMBER OF SHARES'][i] * values['APPLE - FREE FLOAT NOSH'][i] / 100 + \
    values['ALLIANZ'][i] * values['ALLIANZ - NUMBER OF SHARES'][i] * values['ALLIANZ - FREE FLOAT NOSH'][i] / (100 * xrate['EURUSD'][i] ) + \
    values['GENERAL ELECTRIC'][i] * values['GENERAL ELECTRIC - NUMBER OF SHARES'][i] * values['GENERAL ELECTRIC - FREE FLOAT NOSH'][i] / 100 + \
    values['LLOYDS BANKING GROUP'][i] * values['LLOYDS BANKING GROUP - NUMBER OF SHARES'][i] * values['LLOYDS BANKING GROUP - FREE FLOAT NOSH'][i] / (100 * xrate['GBPUSD'][i]) + \
    values['BT GROUP'][i] * values['BT GROUP - NUMBER OF SHARES'][i] * values['BT GROUP - FREE FLOAT NOSH'][i] / (100 * xrate['GBPUSD'][i]) + \
    values['DEUTSCHE POST'][i] * values['DEUTSCHE POST - NUMBER OF SHARES'][i] * values['DEUTSCHE POST - FREE FLOAT NOSH'][i] / (100 * xrate['EURUSD'][i]) + \
...
for i in range(1, nrows):
    ...
    temp[1] = values['ALLIANZ'][i] * values['ALLIANZ - NUMBER OF SHARES'][i] * values['ALLIANZ - FREE FLOAT NOSH'][i] / (100 * xrate['EURUSD'][i] )
    ...
    temp[3] = values['LLOYDS BANKING GROUP'][i] * values['LLOYDS BANKING GROUP - NUMBER OF SHARES'][i] * values['LLOYDS BANKING GROUP - FREE FLOAT NOSH'][i] / (100 * xrate['GBPUSD'][i])
    temp[4] = values['BT GROUP'][i] * values['BT GROUP - NUMBER OF SHARES'][i] * values['BT GROUP - FREE FLOAT NOSH'][i] / (100 * xrate['GBPUSD'][i])
    temp[5] = values['DEUTSCHE POST'][i] * values['DEUTSCHE POST - NUMBER OF SHARES'][i] * values['DEUTSCHE POST - FREE FLOAT NOSH'][i] / (100 * xrate['EURUSD'][i] )
    ...
    divisor = divisor * (2*tempSum - np.dot(temp, shares)) / tempSum
